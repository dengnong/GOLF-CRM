...
<body>
    <div class="warp">
        ...
        <div class="left_c left">
           ...
           <div class="acc">
                <div>
                    <a class="one" target="Conframe" href="../GOLF/Template/productinfo.jsp">产品信息</a>
                    </div>

                      <div>
                    <a class="one" target="Conframe" href="../GOLF/Template/customerinfo.jsp">顾客信息</a>
                    </div>

                <div>
                
                    <a class="one"   target="Conframe" href="../GOLF/Template/VIPinfo.jsp">会员信息</a>

                </div>
                <div>
                    <a class="one"  target="Conframe" href="../GOLF/Template/addProduct.jsp">新增产品</a>
                </div>
                <div>
                    <a class="one"  target="Conframe" href="../GOLF/Template/addVip.jsp">新增会员</a>
                </div>
