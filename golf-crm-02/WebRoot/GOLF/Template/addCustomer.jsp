...
a:visited {
  ...
  <form action="<%=path %>/servlet/CustomerServlet" method="post" onsubmit="return validate_channel_info_addcustomer(this)" name="addcustomeraction">
  <input name="operation" type="hidden" id="operation" value="addcustomer"/>
    ...
    <p>
     ...
     onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#FFF" />
    </p>
	<p>&nbsp;</p>
    <p>
      <label for="customerphone">电话:</label>
      <input type="text" value="" name="customerphone" id="customerphone"
      onFocus="if(value==defaultValue){value='';}" 
      onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#FFF" />
 	</p>
 	<p>&nbsp;</p>
  ...
  <td align="center">&nbsp;</td>
    ...
    <td>女
     ...
     <script src="../Scripts/laydate.js" type="text/javascript" language="javascript"></script>
     ...
     <p>
     <label for="customerbithday">出生年月:</label>
     <input type="text" value="例:1996-11-04" name="customerbirthday" id="customerbirthday" 
     onFocus="if(value==defaultValue){value='';}" 
     onBlur="if(!value){value=defaultValue;this.style.color='#FFF'}" style="color:##FFF" />
    </p>   -->
    <p>&nbsp;</p>
